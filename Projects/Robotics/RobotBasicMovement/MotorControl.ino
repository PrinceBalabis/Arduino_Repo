const int aMotor = 12; //Right Motor A
const int bMotor = 11; //Right Motor B
const int cMotor = 10; //Left Motor C
const int dMotor = 9; //Left Motor D
const int en1Motor = 8; // Right Motor
const int en2Motor = 7; // Left Motor
