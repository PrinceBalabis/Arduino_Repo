...
#define COINSENSOR_LAG_TIME 50 // Sleep a little in order to correct bug where the empty coin circle in danish coins will make the coin counter think its two coins.
