This is a library for fast digital I/O on AVR Arduinos.
...
The DigitalPin class provides very fast inline functions. DigitalPin is a
...
cycles or 125 ns for a 16 MHz CPU.  Fast static functions simular to the
