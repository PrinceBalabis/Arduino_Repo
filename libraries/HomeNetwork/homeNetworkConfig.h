...
#define HOME_SETTING_DEFAULT_TIMEOUT_CONFIRMATION 200 // The amount of time to wait for a confirmation after sending command(A very fast node takes 2ms to respond, make sure its at least that)
