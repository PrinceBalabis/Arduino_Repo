...
const uint8_t homeNetwork_powerAmplifierLevel = RF24_PA_HIGH;  // Set power amplifier to highest
const rf24_datarate_e homeNetwork_dataRate = RF24_250KBPS;  // Set data rate to 250kpbs(other settings: RF24_1MBPS, RF24_2MBPS)

const uint8_t homeNetwork_channel = 40; // Default Home network is using channel 90
